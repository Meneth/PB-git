...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_COUNT_MULT = 3.0, 			-- Extra Max Demesne Size from the ruler's rank
	DEMESNE_MAX_SIZE_DUKE_MULT = 3.0,			-- Extra Max Demesne Size from the ruler's rank
