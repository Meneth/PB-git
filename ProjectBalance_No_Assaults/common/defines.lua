...
NDiplomacy = {
	...
	PRESTIGE_OPINION_MAX = 15,					-- Max opinion impact of prestige (positive OR negative)
	PIETY_OPINION_DIV = 50,						-- Divider for piety to church opinion
	PIETY_OPINION_MAX = 15,						-- Max opinion impact of piety (positive OR negative)	
...
-- Title Revokation Prestige Cost
	BARON_REVOKE_PRESTIGE_COST = 40,
	COUNT_REVOKE_PRESTIGE_COST = 75,
	DUKE_REVOKE_PRESTIGE_COST = 150,
	KING_REVOKE_PRESTIGE_COST = 300,
...
NDecadence = {
	...
	EMPEROR_HOLDING_REDUCTION = -0.15,
	KING_HOLDING_REDUCTION = -0.12,
	DUKE_HOLDING_REDUCTION = -0.09,
	COUNT_HOLDING_REDUCTION = -0.06,
	BARON_HOLDING_REDUCTION = -0.03,
	HAS_JOB_REDUCTION = -0.3,
	ON_JOB_REDUCTION = -0.3,
...
NMilitary = {
	...
	DAYS_PER_FORTLEVEL_BEFORE_ASSAULT = 999999,		-- Number of days until attacker can assault
	...
	LIEGE_LEVY_SIZE_MULTIPLIER = 0.45,				-- The Size of the liege levy will be the total troops in the vassal subrealm * this
...
NAI =
{
	...
	AI_ASSAULT_RATIO = 999,									-- AI will launch assaults at this ratio of attackers to defenders
