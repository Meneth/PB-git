name = "Project Balance: No Ahistorical Empires" # name of your mod, shown in launcher
path = "mod/ProjectBalance_No_Ahistorical_Empires" # location of your mod files 
...
dependencies = { "Project Balance" "PB - SWMH Compatibility" "Some what more historic 2.75" }