...
NDiplomacy = {
	...
	DOWRY_MULTIPLIER = 2.0,						-- The Dowry cost for a Patrician is prestige gain from marriage * this
	...
	SEND_ASSASSIN_INTERACTION_MONEY = 100,
	SEND_ASSASSIN_INTERACTION_PIETY = 10,
	...
	DECLARE_WAR_INTERACTION_PIETY = 10,
	DECLARE_WAR_INTERACTION_PRESTIGE = 50,
...
NReligion = {
	...
	REFORM_RELIGION_MIN_AUTHORITY = 0.3,			-- Moral authority required to reform a pagan faith
	...
	AUTHORITY_FROM_RELHEAD_PIETY = 0.01,			-- Authority from each 100 piety of religious head
	...
	AUTHORITY_FROM_RELHEAD_HOLY_SITE = 0,		-- Authority from religious head controlling a holy site (does not stack)
	AUTHORITY_FROM_ORG_RELIGION = 0.3,				-- Authority from being an organized religion§ki§
...
NEconomy = {
	...
	TRADE_POST_COST_INC_DIST = 0.0075,				-- The % increase in cost due to distance to closest connected province
	TRADE_POST_OPINION_EFFECT = 0.75,				-- The bonus or penalty depending on topliege opinion
...
NMilitary = {
	...
	SIEGE_MORALE_LOSS = 0.25,						-- Monthly morale loss in a siege
	...
	BATTLE_PIETY_MULTIPLIER = 0.75,					-- Piety gain/loss multiplier. This is based on the prestige value, so a value of 1 gives a leader as much piety as he gains prestige from combat
...
NAI =
{
	...
	MARRIAGE_AI_PRESTIGE_VALUE = 0.75,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
